...
const CATEGORIES: CategorySeed[] = [
  {
    ...
    imageUrl: '/assets/categories/auditoria-seo-local.webp',
  ...
  },
  {
    ...
    iconName: 'map-pin',
    imageUrl: '/assets/categories/google-business-profile.webp',
  ...
  },
  {
    ...
    iconName: 'map',
    imageUrl: '/assets/categories/local-pack-y-ranking.webp',
  ...
  },
  {
    ...
    iconName: 'link',
    imageUrl: '/assets/categories/link-building-local.webp',
  ...
  },
  {
    ...
    iconName: 'wrench',
    imageUrl: '/assets/categories/seo-tecnico-local.webp',
  ...
  },
  {
    ...
    iconName: 'file-text',
    imageUrl: '/assets/categories/seo-on-page-local.webp',
  ...
  },
  {
    ...
    iconName: 'star',
    imageUrl: '/assets/categories/reputacion-y-resenas.webp',
  ...
  },
  {
    ...
    iconName: 'book-open',
    imageUrl: '/assets/categories/citaciones-y-nap.webp',
  ...
  },
  {
    ...
    iconName: 'bar-chart',
    imageUrl: '/assets/categories/reportes-y-analytics.webp',
  ...
  },
  {
    ...
    iconName: 'flame',
    imageUrl: '/assets/categories/mapas-calor-local.webp',
  ...
  },
  {
    ...
    iconName: 'pen-tool',
    imageUrl: '/assets/categories/contenido-local.webp',
  ...
  },
  {
    ...
    imageUrl: '/assets/categories/seo-local-ecommerce.webp',
  ...
  },
  {
    ...
    iconName: 'compass',
    imageUrl: '/assets/categories/consultoria.webp',
...
const AGENCIES: AgencySeed[] = [
  {
    ...
    imageUrl: '/assets/agencies/visibilidad-pro-seo.webp',
    city: 'Bogotá',
  ...
  },
  {
    ...
    imageUrl: '/assets/agencies/mapa-ranking-agency.webp',
    city: 'Medellín',
  ...
  },
  {
    ...
    imageUrl: '/assets/agencies/eje-cafetero-posicionamiento.webp',
    city: 'Manizales',
  ...
  },
  {
    ...
    imageUrl: '/assets/agencies/impulsa-local-studio.webp',
    city: 'Cali',
  ...
  },
  {
    ...
    imageUrl: '/assets/agencies/seo-local-colombia.webp',
    city: 'Barranquilla',
  ...
  {
    name: 'Local Rankers',
    imageUrl: '/assets/agencies/local-rankers.webp',
    city: 'Bucaramanga',
  ...
  {
    name: 'SEO Certero',
    imageUrl: '/assets/agencies/seo-certero.webp',
    city: 'Pereira',
  ...
  },
  {
    ...
    imageUrl: '/assets/agencies/santander-local-rank.webp',
    city: 'Cúcuta',
  ...
  },
  {
    ...
    imageUrl: '/assets/agencies/estrategia-local.webp',
    city: 'Cartagena',
...
async function seedAgencies(
  ...
  for (const [index, agencySeed] of AGENCIES.entries()) {
    ...
    if (
      !agency.imageUrl ||
      agency.imageUrl.startsWith('http') ||
      agency.imageUrl.includes('category-default')
    ) {
      await agencyRepo.update(agency.id, { imageUrl: agencySeed.imageUrl });
      agency.imageUrl = agencySeed.imageUrl;
    }
  ...
  const offers = [
    {
      ...
      imageUrl: '/assets/offers/auditoria-seo-local.webp',
      status: 'active',
    },
    {
      ...
      imageUrl: '/assets/offers/google-business-profile.webp',
      status: 'active',
    },
  ] as const;
