        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 lg:py-20">
          <div className="grid gap-8 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] items-start">
            ...
            <div className="rounded-3xl border border-gray-200 bg-white shadow-xl overflow-hidden">
              ...
              <div className="border-t border-gray-200 bg-gray-50 p-6 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4"><div><p className="text-[10px] font-black uppercase tracking-[0.16em] text-gray-400">Estimado</p><p className="mt-1 text-4xl font-black text-[#333]"><DemoPrice price={moduleQuotePreview.estimatedPrice}>${moduleQuotePreview.estimatedPrice}</DemoPrice></p><p className="mt-1 text-xs font-bold text-gray-500">{moduleQuotePreview.activeCount} módulos · {moduleQuotePreview.estimatedDeliveryDays} días</p></div><button disabled={isQuoting} onClick={handleCreateQuote} className="rounded-xl bg-[#333] px-5 py-3.5 text-sm font-extrabold text-white transition hover:bg-black disabled:opacity-60">{isQuoting ? 'Guardando...' : 'Guardar cotización'}</button></div>
