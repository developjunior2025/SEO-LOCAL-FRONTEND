          ...
          <div className="grid gap-10 lg:grid-cols-[1.02fr_0.98fr] lg:items-center">
            <div>
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                ...
                <button type="button" onClick={() => { navigate('/categorias/reputacion-y-resenas'); }} className="inline-flex items-center justify-center gap-2 rounded-xl border border-gray-300 bg-white px-6 py-3 text-xs font-black uppercase tracking-wider text-[#333] hover:border-[#D32323]/50 hover:text-[#D32323] transition">
